...
pub trait Asset: Clone + Sized {
    ...
    type Context: Context<Asset=Self, Data=Self::Data, Error=Self::Error, Result=Self::Result>;
    ...
    /// The result type of `Self::Context::create_asset`
...
pub trait Context {
    ...
    /// Result type of `create_asset`
    /// `std::result::Result<Self::Asset, Self::Error>` will do in most cases
    ...
    fn retrieve(&self, _spec: &AssetSpec) -> Option<Self::Result> {
        None
    }
