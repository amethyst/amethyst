...
use {
    Anchor, FontAsset, FontFormat, MouseReactive, Stretch, TextEditing, UiButton, UiFocused,
    ...
    AF: Format<Audio, Options = ()>,
{
    ...
    /// Default image
    pub normal_image: TexturePrefab<TF>,
    ...
    AF: Format<Audio, Options = ()> + Clone,
{
    ...
    fn load_prefab(
        ...
        let (ref mut buttons, ref mut textures, ref mut sounds) = system_data;
    ...
    fn trigger_sub_loading(
        ...
        let (_, ref mut textures, ref mut sounds) = system_data;
    ...
    match widget {
        ...
        UiWidget::Button { transform, button } => {
            ...
            prefab.entity(current_index).unwrap().set_data((
                Some(transform),
                Some(UiImageBuilder {
                    image: button.normal_image.clone(),
                }),
                None,
                Some(button),
            ));
