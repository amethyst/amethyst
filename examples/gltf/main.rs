...
fn main() -> Result<(), amethyst::Error> {
    ...
    let game_data = GameDataBuilder::default()
        ...
        .with_basic_renderer(path, DrawPbmSeparate::<f32>::new().with_vertex_skinning(), false)?
        .with_bundle(
            AnimationBundle::<usize, Transform<f32>>::new("animation_control", "sampler_interpolation")
