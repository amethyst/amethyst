use amethyst::{core::{math::{Point3, Vector2}, transform::Transform}, ecs::{ParallelRunnable, System,IntoQuery}, input::InputHandler, renderer::{ActiveCamera, Camera, debug_drawing::DebugLinesComponent}, window::ScreenDimensions};
    ...
    fn build(&'static mut self) -> Box<dyn ParallelRunnable> {
        Box::new(
            SystemBuilder::new("DrawSelectionSystem")
                ...
                .build( move |_commands, world, (active_camera, dimensions, input), (debug_lines_query, camera_query)| {
