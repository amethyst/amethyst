...
fn initialise_paddles(world: &mut World) {
    ...
    left_transform.set_position(Vector3::new(0.0, left_y, 0.0));
    right_transform.set_position(Vector3::new(arena_width - right_width, right_y, 0.0));
...
fn initialise_balls(world: &mut World) {
    ...
    let local_transform = Transform::default()
        .with_position(Vector3::new(arena_width / 2.0, arena_height / 2.0, 0.0));
