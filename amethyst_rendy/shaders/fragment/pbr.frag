...
layout(set = 3, binding = 0) uniform sampler2D ltc_1;
layout(set = 3, binding = 1) uniform sampler2D ltc_2;
#include "header/ltc.glsl"
...
void main() {
    ...
    float roughness2 = max(roughness * roughness, 0.03);
